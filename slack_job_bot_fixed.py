        ...
        sample_jobs = [
            {
                ...
                "location": "Bangalore",
                "industry": "Healthcare",
                "description": "Looking for an experienced PM to lead our healthcare platform initiatives.",
            ...
            },
            {
                ...
                "industry": "Finance",
                "description": "Join our team to build the next generation of payment products.",
        ...
        sample_jobs = [
            {
                ...
                "location": "Hyderabad",
                "industry": "Healthcare",
                "description": "Seeking a PM passionate about healthcare technology.",
...
if __name__ == "__main__":
    ...
    if not slack_token:
        ...
        print("\nTo fix this, run these commands in your terminal BEFORE running the bot:")
        print("\n  export SLACK_BOT_TOKEN='xoxb-your-token-here'")
        print("  export LINKEDIN_COOKIE='your-cookie-here'")
        print("  python slack_job_bot.py")
        print("\nOr set them and run all at once:")
        print("\n  SLACK_BOT_TOKEN='xoxb-your-token' LINKEDIN_COOKIE='your-cookie' python slack_job_bot.py")
        exit(1)

    print(f"✓ Slack token found")
    if linkedin_cookie:
        print(f"✓ LinkedIn cookie found")
    else:
        print(f"⚠️  LinkedIn cookie not set (network posts will be skipped)")

    # Create bot instance
    try:
        bot = JobPostingBot(
            slack_token=slack_token,
            channel_name='job-notifications',
